...
@app.route('/test')
def hello():
    return static_file('test.html', root='vpwboard/static')

@app.route('/icon.png')
def favicon():
    return static_file('icon.png', root='vpwboard/static/images')
...
def serve_css(cssname):
    return static_file(cssname, root='vpwboard/static/css')

@app.route('/js/<jsname>')
def serve_js(jsname):
    return static_file(jsname, root='vpwboard/static/js')

@app.route('/js/lib/<libname>')
def serve_jslib(libname):
    return static_file(libname, root='vpwboard/static/js/lib')
...
def init_anchor(anchor='home'):
    if anchor in ALLOW_ANCHOR:
        return static_file('pen.html', root='vpwboard/static')
